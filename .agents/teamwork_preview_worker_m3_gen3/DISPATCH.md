...
6. Write `handoff.md` in your working directory `c:\Projects\fusion-router\.agents\teamwork_preview_worker_m3_gen3` detailing changes, test commands, and output.
