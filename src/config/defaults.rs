...
pub fn default_rate_limiting_enabled() -> bool {
    true
}
pub fn default_rpm() -> u64 {
    60
}
...
pub fn default_max_concurrent_nodes() -> u32 {
    16
}
...
pub fn default_consensus_count() -> u32 {
    3
}
...
pub fn default_allowed_shell_commands() -> Vec<String> {
    vec![]
}
pub fn default_shell_timeout_secs() -> u64 {
    10
}
pub fn default_allowed_read_directories() -> Vec<String> {
    vec![".".into()]
}
pub fn default_enable_http_tool() -> bool {
    false
}
pub fn default_allow_auto_exec() -> bool {
    false
}
